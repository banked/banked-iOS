...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "kristinaSl"
  # spec.authors            = { "kristinaSl" => "kristina.sl.nenkova@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/kristinaSl"
  ...
  # spec.public_header_files = "Classes/**/*.h"
   ...
   spec.resources = "**/Banked.framework/*.{otf,json,nib,xcassets}"
